...
export declare type SvelteUiProviderProps = typeof __propDef.props;
export declare type SvelteUiProviderEvents = typeof __propDef.events;
export declare type SvelteUiProviderSlots = typeof __propDef.slots;
export default class SvelteUiProvider extends SvelteComponentTyped<SvelteUiProviderProps, SvelteUiProviderEvents, SvelteUiProviderSlots> {
}
export {};

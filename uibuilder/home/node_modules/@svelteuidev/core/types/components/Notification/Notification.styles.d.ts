...
declare const _default: (params?: NotificationStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"title" | "content" | "icon" | "root" | "closeButton" | "description" | "loader">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"title" | "content" | "icon" | "root" | "closeButton" | "description" | "loader", string>;

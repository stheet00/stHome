import type { SvelteUIColor, SvelteUISize } from '../../styles';
...
declare const _default: (params?: RadioStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "label" | "root" | "inner" | "inputContainer" | "container">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "label" | "root" | "inner" | "inputContainer" | "container", string>;

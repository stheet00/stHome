import type { SvelteUINumberSize, SvelteUIColor } from '../../styles';
...
declare const _default: (params?: FileUploadStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"drag" | "input" | "icon" | "root" | "active" | "inputContainer" | "uploadIcon" | "fileItemWrapper" | "fileItemIcon" | "fileItemName" | "fileItemAction" | "buttonType">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"drag" | "input" | "icon" | "root" | "active" | "inputContainer" | "uploadIcon" | "fileItemWrapper" | "fileItemIcon" | "fileItemName" | "fileItemAction" | "buttonType", string>;
    getStyles: import("@stitches/core/types/styled-component").CssComponent<any, any, {
        xs: "(min-width: 576px)";
        sm: "(min-width: 768px)";
        md: "(min-width: 992px)";
        lg: "(min-width: 1200px)";

...
declare const _default: (params?: BreadcrumbItemStylesParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"icon" | "root" | "separator" | "wrapper" | "innerText">) => {
    cx: (...args: import("../../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../../styles").SvelteUITheme;
    classes: Record<"icon" | "root" | "separator" | "wrapper" | "innerText", string>;

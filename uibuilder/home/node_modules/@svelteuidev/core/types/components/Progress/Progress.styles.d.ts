import type { SvelteUINumberSize, SvelteUIColor, ColorShades } from '../../styles';
...
declare const _default: (params?: ProgressStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"label" | "root" | "bar">) => {

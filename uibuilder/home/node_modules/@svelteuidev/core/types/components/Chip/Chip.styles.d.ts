import type { SvelteUIColor, SvelteUINumberSize, SvelteUISize } from '../../styles';
...
declare const _default: (params?: ChipStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "label" | "root" | "iconWrapper" | "checkIcon" | "inputContainer">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "label" | "root" | "iconWrapper" | "checkIcon" | "inputContainer", string>;

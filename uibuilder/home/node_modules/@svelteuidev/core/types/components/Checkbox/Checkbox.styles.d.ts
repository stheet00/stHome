...
declare const _default: (params?: CheckboxStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"input" | "label" | "icon" | "root" | "inner" | "iconWrapper">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"input" | "label" | "icon" | "root" | "inner" | "iconWrapper", string>;

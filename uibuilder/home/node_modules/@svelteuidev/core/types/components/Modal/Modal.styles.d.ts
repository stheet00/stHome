...
declare const _default: (params?: ModalStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"close" | "body" | "header" | "title" | "overlay" | "root" | "inner" | "modal">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"close" | "body" | "header" | "title" | "overlay" | "root" | "inner" | "modal", string>;

...
declare const __propDef: {
    props: {
        ...
        tabindex?: number;
        inert?: boolean;
        role?: import("svelte/elements").AriaRole & string;
        about?: string;
        datatype?: string;
        inlist?: any;
        property?: string;
        ...
        'on:submit'?: import("svelte/elements").EventHandler<Event, HTMLButtonElement>;
...
export declare type MenuIconProps = typeof __propDef.props;
export declare type MenuIconEvents = typeof __propDef.events;
export declare type MenuIconSlots = typeof __propDef.slots;

...
declare const _default: (params?: MenuStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"label" | "root" | "arrow" | "svelteui-Menu-body">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"label" | "root" | "arrow" | "svelteui-Menu-body", string>;

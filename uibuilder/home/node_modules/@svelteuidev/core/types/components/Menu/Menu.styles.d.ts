...
declare const _default: (params?: MenuStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"body" | "label" | "root" | "arrow">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"body" | "label" | "root" | "arrow", string>;

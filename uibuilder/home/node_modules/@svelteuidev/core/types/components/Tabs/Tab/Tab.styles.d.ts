import type { SvelteUIColor, SvelteUITheme, VariantThemeFunction } from '../../../styles';
...
declare const _default: (params?: TabStyleParams, options?: import("../../../styles/engine/create-styles").UseStylesOptions<"label" | "icon" | "root" | "inner" | "tabContent">) => {
    cx: (...args: import("../../../styles/engine/css").ArgumentArray) => string;
    theme: SvelteUITheme;
    classes: Record<"label" | "icon" | "root" | "inner" | "tabContent", string>;

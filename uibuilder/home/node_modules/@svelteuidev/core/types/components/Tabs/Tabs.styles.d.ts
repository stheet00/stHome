import type { SvelteUINumberSize, SvelteUITheme, VariantThemeFunction } from '../../styles';
export interface TabsStyleParams {
    orientation?: 'horizontal' | 'vertical';
    tabPadding?: SvelteUINumberSize;
}
export declare const getVariantStyles: (orientation: 'horizontal' | 'vertical', theme: SvelteUITheme, getRef: any) => VariantThemeFunction;

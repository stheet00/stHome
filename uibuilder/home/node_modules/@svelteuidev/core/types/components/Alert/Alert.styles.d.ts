...
declare const _default: (params?: AlertStylesParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"label" | "title" | "message" | "content" | "icon" | "root" | "closeButton" | "wrapper">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"label" | "title" | "message" | "content" | "icon" | "root" | "closeButton" | "wrapper", string>;
